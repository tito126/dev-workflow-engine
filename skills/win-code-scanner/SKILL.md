...
description: 代码扫描与评审技能，支持前端(Vue/JS/TS)和后端(Java/SQL/YAML)项目的智能代码审查。扫描规则覆盖：前端12条（性能1条、框架2条、工程3条、安全2条、语法4条）、
  后端36条（性能17条、安全3条、业务3条、工程3条、语法6条、框架1条、架构2条、质量1条）。当用户需要进行代码扫描、代码评审、检查代码问题时使用。
---
