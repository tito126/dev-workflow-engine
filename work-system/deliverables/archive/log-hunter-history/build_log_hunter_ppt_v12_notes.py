...
SOURCE = os.path.join(BASE, "log-hunter-ai-presentation-2026-03-21-v11-notes.pptx")
TARGET = os.path.join(BASE, "log-hunter-ai-presentation-2026-03-21-v12-notes.pptx")
SCRIPT_OUT = os.path.join(BASE, "log-hunter-ai-presentation-2026-03-21-v12-speech.md")
COLLOQUIAL_OUT = os.path.join(BASE, "log-hunter-ai-presentation-2026-03-21-v12-speech-colloquial.md")
...
if not os.path.exists(SOURCE):
    raise RuntimeError("v11-notes source ppt not found")
...
colloquial_md = """接下来我会从四个部分展开：第一部分讲项目背景和目标；第二部分讲技术思路和能力边界；第三部分讲成果展示和应用价值；第四部分讲总结和未来规划。
...
with open(COLLOQUIAL_OUT, 'w', encoding='utf-8') as f:
    f.write(colloquial_md)

print(TARGET)
print(SCRIPT_OUT)
print(COLLOQUIAL_OUT)
